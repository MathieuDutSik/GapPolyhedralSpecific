...
CutPolytope:=function(n)
  local LSET, EXT, eSet, V, i, j, H, DistMat, eList, CyclePerm, CycleList, ListVect, eVect, rVect, fVect, ePerm, L\
istPermGenRed, eGen, GRPred, EXTdelaunay;
  ...
  do
    ...
    ePerm:=PermList(eList);
    if ePerm=fail then
      Error("Please debug from this point\n");
    fi;
